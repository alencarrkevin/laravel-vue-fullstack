  ...
  <main>
    <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <form @submit.prevent="submit">
        <div class="mb-4">
          <label for="cover-photo" class="block font-medium text-gray-900 text-sm/6">Image</label>
        ...
        <div class="mb-4">
          <label for="label" class="block font-medium text-gray-900 text-sm/6">Label</label>
          <div class="mt-2">
            <input type="text"
                   name="label"
                   id="label"
