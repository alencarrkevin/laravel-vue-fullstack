  ...
  <GuestLayout>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form @submit.prevent="submit" class="space-y-4">
        <div>
          <label for="name" class="block font-medium text-gray-900 text-sm/6">Full Name</label>
          <div class="mt-2">
            <input name="name"
                   id="name"
                   v-model="data.name"
        ...
        <div>
          <div class="flex items-center justify-between">
            <label for="passwordConfirmation" class="block font-medium text-gray-900 text-sm/6">Repeat Password</label>
          </div>
          <div class="mt-2">
            <input type="password"
                   name="password"
